...
public enum TokenType implements Serializable {
   ...
   * This type is associated with tokens that represent data size with units like
   * B, KB, MB, GB, TB, PB. E.g. "10KB", "1.5MB", "2GB"
   */
  BYTE_SIZE,
  
  /**
   * Represents the enumerated type for the object of type {@code TimeDuration}.
   * This type is associated with tokens that represent time duration with units like
   * ns, us, ms, s, m, h, d. E.g. "10ms", "1.5s", "30m"
   */
  TIME_DURATION
}
